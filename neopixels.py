...
def blue(value=None):
    if value is None:
        value = 255
    strip.setPixelColorRGB(0, 0,0,value) 
    strip.show()

def green(value=None):
    if value is None:
        value = 255
    strip.setPixelColorRGB(0, 0,value,0) 
    strip.show()

def red(value=None):
    if value is None:
        value = 255
    strip.setPixelColorRGB(0, value,0,0) 
    strip.show()

def white(value=None):
    if value is None:
        value = 255
    strip.setPixelColorRGB(0, value,value,value) 
    strip.show()        
